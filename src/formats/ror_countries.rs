...
pub static ROR_COUNTRIES: &[(&str, &[&str])] = &[
    ...
    ("CG", &["congo", "democratic republic of the congo", "republic of the congo",
             "republique democratique du congo", "republique du congo"]),
    ("CH", &["che", "schweiz", "suisse", "svizzera", "switzerland"]),
    ("CI", &["cote d'ivoire"]),
    ("CK", &["cook islands"]),
    ("CL", &["chile"]),
    ("CM", &["cameroon", "cameroun"]),
    ("CN", &["china", "china (people's republic of)", "chn", "cn",
             "people's republic of china", "p r china", "p. r. china", "pr china",
             "republic of china", "r. o. c.", "zhong guo"]),
    ("CO", &["col", "colombia"]),
    ("CR", &["costa rica", "cri"]),
    ("CU", &["cuba"]),
    ...
    ("KR", &["kor", "korea", "republic of korea", "korea (republic of)", "south korea",
             "taehan-min'guk"]),
    ("KW", &["al kuwayt", "kuwait"]),
    ("KY", &["cayman islands"]),
    ...
    ("MG", &["madagascar"]),
    ("MH", &["marshall islands"]),
    ("MK", &["federal republic of yugoslavia", "former yugoslav republic of macedonia",
             "macedonia", "makedonija", "yugoslavia"]),
    ("ML", &["mali"]),
    ...
    ("UG", &["uganda"]),
    ("UK", &["gb", "gbr", "great britain", "northern ireland", "london", "scotland",
             "uk", "u. k.", "u.k.", "u. k", "u.k", "united kingdom"]),
    ("UM", &["united states minor outlying islands"]),
    ("US", &["ak", "al", "alabama", "alaska", "ar", "arizona", "arkansas", "az",
             "ca", "california", "co", "colorado", "connecticut", "ct", "de", "delaware",
             "fl", "florida", "ga", "georgia", "hawaii", "hi", "ia", "id", "idaho",
             "il", "ill", "illinois", "in", "indiana", "iowa", "kansas", "kentucky",
             "ks", "ky", "la", "louisiana", "ma", "maine", "maryland", "massachusetts",
             "me", "mi", "michigan", "minnesota", "mississippi", "missouri", "mn", "mo",
             "montana", "ms", "mt", "nc", "nd", "ne", "nebraska", "nevada",
             "new hampshire", "new jersey", "new mexico", "new york", "nh", "nj", "nm",
             "north carolina", "north dakota", "nv", "ny", "oh", "ohio", "ok", "okla",
             "oklahoma", "or", "oregon", "pa", "pennsylvania", "rhode island", "ri",
             "sc", "sd", "south carolina", "south dakota", "tennessee", "texas", "tn",
             "tx", "united states", "united states of america", "us", "u. s.", "u.s.",
             "u. s", "u.s", "usa", "u. s. a.", "u.s.a.", "ut", "utah", "va", "vermont",
             "virginia", "vt", "wa", "washington", "west virginia", "wi", "wisconsin",
             "wv", "wy", "wyoming"]),
    ("UY", &["uruguay"]),
